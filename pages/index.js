...
function Home() {
  const { data, error } = useSWR('https://dl-proxypool-api.toshiki.dev/api', fetcher)
        ...
        <main className={styles.main}>
            ...
            <div className="col-4 col-md-4 col-sm-12">
              ...
              <ul className="list-group">
                {release_items.map((item) => (
                  <a href={"https://dl-proxypool-api.toshiki.dev/" + item.key}>
          ...
          <center>
            <footer className={styles.footer}>
              Crafted with {' '}
              <span className="text-danger"><i className="fa fa-heart" aria-hidden="true"></i></span> by Anda Toshiki.
              {/* <br />
